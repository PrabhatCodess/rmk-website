...
export class Backend implements backendInterface {
    ...
    async addGuestReview(arg0: string, arg1: bigint, arg2: string, arg3: string): Promise<void> {
    ...
    async getAllGuestReviews(): Promise<Array<GuestReview>> {
        if (this.processError) {
            try {
    ...
    async submitBookingInquiry(arg0: string, arg1: string, arg2: string, arg3: string, arg4: bigint, arg5: string): Promise<void> {
        if (this.processError) {
            try {
