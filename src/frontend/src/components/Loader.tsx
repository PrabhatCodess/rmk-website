    ...
    <AnimatePresence>
      {progress < 100 && (
        <motion.div
          ...
          style={{ background: "#000 url('/assets/generated/hero-temple-shrine.dim_1200x700.jpg') center/cover no-repeat" }}
        >
          <div className="flex flex-col items-center justify-center gap-8">
            <motion.img
              ...
              className="w-24 h-24 drop-shadow-xl rounded-full border-4 border-white/60 bg-white/60"
